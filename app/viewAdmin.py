...
from models import User, Ask, Friend, ContactUs, Recommendation, SendAsk, ReplyRecommendation,Ads,SendRecommendation,Review
...
admin.register(SendRecommendation, session=db.session)
